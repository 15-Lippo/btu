...
import { Currency, Token } from '@dexs/sdk'
...
const VoteCard = styled.div`
  ...
  border-radius: 8px;
  box-shadow:  inset 1px 1px 2px 1px #292d4d, 3.40642px 3.40642px 22.92px rgb(0 0 0 / 65%)
`
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                ...
                POWERED BY  <span role="img" aria-label="love"></span> ZONULET
                <div>
                <span style={{position: 'relative', top: '5px', fontWeight: 'bold', color:'#16ceb9', fontSize:'11px', backgroundColor: 'rgb(10 252 214 / 7%)', boxShadow: 'rgb(10 252 252 / 31%) 2px 4px 80px'}}>zonulet.io</span>
                </div>
                </TYPE.body>
              </RowBetween>
            </AutoColumn>
