...
import { Currency, currencyEquals, Percent, CurrencyAmount, JSBI, ChainId, RoutablePlatform } from '@dexs/sdk'
...
export default function RemoveLiquidity({
  ...
  const routerAddress = RoutablePlatform.DEXSWAP.routerAddress[chainId ? chainId : ChainId.HARMONY]
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {'DEXS ' + currencyA?.symbol + '/' + currencyB?.symbol} Burned
          </Text>
          <RowFixed>
