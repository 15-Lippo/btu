import { Currency, CurrencyAmount, Pair } from '@dexs/sdk'
...
const CurrencySelect = styled.button<{ selected: boolean }>`
  ...
  background: linear-gradient(134deg, #262a3e 0%, #1d202f 100%);
  border-radius: 8px;
  height: 45px;
  width: 150px;
...
const Container1 = styled.div<{ focused: boolean }>`
  height: 95px;
