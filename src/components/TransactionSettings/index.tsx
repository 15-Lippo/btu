...
export default function SlippageTabs({
  ...
  useEffect(() => {
    ...
    if (chainId !== ChainId.HARMONY && rawPreferredGasPrice && rawPreferredGasPrice in MainnetGasPrice) {
  ...
  useEffect(() => {
    if (rawPreferredGasPrice) {
      if (chainId !== ChainId.HARMONY && rawPreferredGasPrice in MainnetGasPrice) {
