import { ChainId, Currency, Token, ZDEX } from '@dexs/sdk'
import React, { ReactNode, useMemo } from 'react'
import Skeleton from 'react-loading-skeleton'
import styled from 'styled-components/macro'

import EthereumLogo from '../../assets/images/ethereum-logo.jpg'
import ZDEXLogo from '../../assets/images/DexSwapZoo.png'
...
export default function CurrencyLogo({
  ...
  const srcs: string[] = useMemo(() => {
    ...
    if (currency instanceof Token) {
      ...
      if (chainId && ZDEX[chainId] && ZDEX[chainId].address === currency.address) return [ZDEXLogo]
