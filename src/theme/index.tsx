...
export const colorBox = styled.div`
  ...
  background-color: rgb(10 235 252 / 7%);
  box-shadow: rgb(10 252 252 / 31%) 2px 4px 80px;
`
...
#root {
  ...
  background: url(https://raw.githubusercontent.com/Agin-DropDisco/dexs-factory/core-v1/world_zonulet.png);
  background-repeat: no-repeat;
