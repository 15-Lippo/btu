import { TokenAmount, Pair, Currency, RoutablePlatform } from '@dexs/sdk'
import { useMemo } from 'react'
import { abi as IDexSwapPairABI } from '@dexs/core/build/IDexSwapPair.json'
...
export function usePairs(
  ...
  return useMemo(() => {
    return results.map((result, i) => {
      ...
      if (!swapFee && platform === RoutablePlatform.DEXSWAP) return [PairState.LOADING, null]
      return [
        PairState.EXISTS,
        new Pair(
