...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [ZDEX[ChainId.RINKEBY]],
  [ChainId.HARMONY]: [WONE[ChainId.HARMONY]],
  [ChainId.HARMONY_TESTNET]: [WONE[ChainId.HARMONY_TESTNET],  ZDEX[ChainId.HARMONY_TESTNET]],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.RINKEBY]: [
    [ZDEX[ChainId.RINKEBY], WETH[ChainId.RINKEBY]],
    [ZDEX[ChainId.RINKEBY], WBTC[ChainId.RINKEBY]],
  ],
  [ChainId.HARMONY]: [
    [WONE[ChainId.HARMONY], ZDEX[ChainId.HARMONY]],
  ...
  [ChainId.HARMONY_TESTNET]: [
    [ZDEX[ChainId.HARMONY_TESTNET], WONE[ChainId.HARMONY_TESTNET]],
    [ZDEX[ChainId.HARMONY_TESTNET], USDC[ChainId.HARMONY_TESTNET]],
    [ZDEX[ChainId.HARMONY_TESTNET], USDT[ChainId.HARMONY_TESTNET]],
    [ZDEX[ChainId.HARMONY_TESTNET], DAI[ChainId.HARMONY_TESTNET]],
    [ZDEX[ChainId.HARMONY_TESTNET], WBTC[ChainId.HARMONY_TESTNET]],
...
export const DEFAULT_TOKEN_LIST = 'https://raw.githubusercontent.com/zonulet-io/Zonulet-Assets/main/tokenList/DexSwap.json'
...
export const NETWORK_DETAIL: { [chainId: number]: NetworkDetails } = {
  [ChainId.HARMONY]: {
    ...
    chainName: 'HARMONY',
    nativeCurrency: {
      name: Currency.HARMONY.name || 'ONE',
      symbol: Currency.HARMONY.symbol || 'ONE',
      decimals: Currency.HARMONY.decimals || 18
    },
