...
import { abi as IDexSwapRouterABI } from '@dexs/router/build/IDexSwapRouter.json'
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, Pair, RoutablePlatform } from '@dexs/sdk'
...
export function getRouterContract(
  ...
  return getContract(
    platform.routerAddress[chainId ? chainId : ChainId.HARMONY] as string,
    IDexSwapRouterABI,
    library,
    account
  )
